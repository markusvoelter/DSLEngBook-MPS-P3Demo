...
<model modelUID="r:42e15580-ce55-43af-8970-3dd6fa00dcc8(org.dslengineering.p3demo.JsmDsl.typesystem)">
  ...
  <roots>
    ...
    <node type="tpd4.InferenceRule" typeId="tpd4.1174643105530" id="4928802662337920030">
  ...
  <root id="4928802662337920030">
    <node role="body" roleId="tpd4.1195213635060" type="tpee.StatementList" typeId="tpee.1068580123136" id="4928802662337920031">
      <node role="statement" roleId="tpee.1068581517665" type="tpd4.CreateEquationStatement" typeId="tpd4.1174658326157" id="4928802662337920037">
        <node role="rightExpression" roleId="tpd4.1174660783414" type="tpd4.NormalTypeClause" typeId="tpd4.1185788614172" id="4928802662337920041">
          <node role="normalType" roleId="tpd4.1185788644032" type="tp3r.Quotation" typeId="tp3r.1196350785113" id="4928802662337920042">
            <node role="quotedNode" roleId="tp3r.1196350785114" type="tpee.BooleanType" typeId="tpee.1070534644030" id="4928802662337920044" />
          </node>
        </node>
        <node role="leftExpression" roleId="tpd4.1174660783413" type="tpd4.NormalTypeClause" typeId="tpd4.1185788614172" id="4928802662337920040">
          <node role="normalType" roleId="tpd4.1185788644032" type="tpd4.TypeOfExpression" typeId="tpd4.1174657487114" id="4928802662337920034">
            <node role="term" roleId="tpd4.1174657509053" type="tpd4.ApplicableNodeReference" typeId="tpd4.1174650418652" id="4928802662337920036">
              <link role="applicableNode" roleId="tpd4.1174650432090" targetNodeId="4928802662337920032" resolveInfo="expr" />
            </node>
          </node>
        </node>
      </node>
    </node>
    <node role="applicableNode" roleId="tpd4.1174648101952" type="tpd4.ConceptReference" typeId="tpd4.1174642788531" id="4928802662337920032">
      <property name="name" nameId="tpck.1169194664001" value="expr" />
      <link role="concept" roleId="tpd4.1174642800329" targetNodeId="qglu.4928802662337920001" resolveInfo="StateCheckExpr" />
    </node>
  </root>
</model>
